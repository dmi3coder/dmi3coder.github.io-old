<html><head>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9 text-center filterprogiddximagetransformmicrosoftgradientendcolorstrc0cfe2-startcolorstr='#ffffff',-gradienttype='0'); blackbg">
                        ...
                        <br>
                        <br>
                        <a class="btn btn-lg btn-primary">Contact me<br></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <img src="images/exp_dmi3cafe.png" class="img-responsive">
                    </div>
                    <div class="col-md-6">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <h2>Some more</h2>
                        <p>Have few
                            <a href="#">experience with jMonkeyEngine</a>, Spring Framework and huge amount of libraries. Also have good experience
